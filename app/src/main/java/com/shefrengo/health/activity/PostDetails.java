...
public class PostDetails extends AppBaseActivity implements View.OnClickListener {
    ...
    private void getFirestoreInfo() {
        AppExtensionsKt.loadImageFromUrl(userProfile,photo,R.drawable.ic_profile,R.drawable.ic_profile);
        ...
        if (user != null) {
            collectionReference.document(user.getUid()).get().addOnSuccessListener(documentSnapshot -> {
                ...
                AppExtensionsKt.loadImageFromUrl(myProfile,photo,R.drawable.ic_profile,R.drawable.ic_profile);
    ...
    private void getInfo() {
        if (!image.isEmpty()) {
            ...
            AppExtensionsKt.loadImageFromUrl(imageView,image,R.drawable.placeholder,R.drawable.placeholder);
        }
            ...
            for (QueryDocumentSnapshot queryDocumentSnapshot : queryDocumentSnapshots) {
                ...
                db.collection("Posts").document(id).delete()
                        .addOnSuccessListener(aVoid -> {
                            ...
                            Intent intent = new Intent(PostDetails.this, BoardActivity.class);
