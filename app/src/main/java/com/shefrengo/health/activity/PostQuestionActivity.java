...
public class PostQuestionActivity extends AppBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppExtensionsKt.loadImageFromDrawable(imageView,R.drawable.placeholder);
    ...
    private void uploadPostInfo(String imageUri) {
        ...
        collectionReference.add(posts).addOnSuccessListener(documentReference -> {
            ...
            Intent intent = new Intent(PostQuestionActivity.this, BoardActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                AppExtensionsKt.loadImageFromUrl(imageView,profileImageUri.toString(),R.drawable.placeholder,R.drawable.placeholder);
